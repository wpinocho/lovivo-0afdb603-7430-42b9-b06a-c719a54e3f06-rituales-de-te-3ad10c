...
type CartAction =
  | { type: 'ADD_ITEM'; payload: { product: Product; variant?: ProductVariant; sellingPlan?: SellingPlan } }
  ...
  switch (action.type) {
    case 'ADD_ITEM': {
      ...
      if (existingItem) {
        ...
        newItems = [...state.items, { type: 'product' as const, key, product, variant, sellingPlan, quantity: 1 }]
      }
...
interface CartContextType {
  state: CartState
  addItem: (product: Product, variant?: ProductVariant, sellingPlan?: SellingPlan) => boolean
...
export const CartProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addItem = (product: Product, variant?: ProductVariant, sellingPlan?: SellingPlan): boolean => {
